...
export default class VideoPlayer extends Component {
  ...
  renderVolume() {
    return (
      <View style={VideoPlayerstyles.volume.container}>
        <View style={[VideoPlayerstyles.volume.fill, { width: this.state.volumeFillWidth }]} />
        <View style={[VideoPlayerstyles.volume.track, { width: this.state.volumeTrackWidth }]} />
        <View
  ...
  renderMiddleControls() {
    ...
    return (
      ...
      >
        ...
        {/* {backwardControl} */}
        <SafeAreaView style={[VideoPlayerstyles.controls.row, VideoPlayerstyles.controls.middle]}>
          {pausePlayControl}
          {this.renderTitle()}
          {/* {forwardControl} */}
        </SafeAreaView>
  ...
  renderPlay() {
    let name = this.state.paused === true ? 'play-circle-outline' : 'pause-circle-outline';
    return this.renderControl(
      <Icon
        name={name}
        type="MaterialIcons"
