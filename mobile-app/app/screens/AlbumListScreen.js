        ...
        return (
            <TouchableOpacity style={{ flexDirection: 'column', }}
                ...
                <View style={{ marginRight: 10, flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <Texts size={15} color={colors.iondigoDye} style={{ marginLeft: 20 }}>Create Album</Texts>
                </View>
                <Separator />
            </TouchableOpacity>
        )
            ...
            <TouchableOpacity style={{ flexDirection: 'column', }} onPress={() => {
                ...
                <View style={{ marginRight: 10, flexDirection: 'row', alignItems: 'center', }}>
                    ...
                    <View style={{ marginVertical: 10, paddingLeft: 20 }}>
                        <Texts size={15} color={colors.dark} >{item.albumName}</Texts>
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 5 }}>
                            <Texts size={12} color={colors.dimGray} >{item.media.length}</Texts>
                            <Texts size={12} color={colors.dimGray} style={{ marginLeft: 2 }}> posts </Texts>
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 5 }}>
                            <Icon
                                image={9}
                            ...
                            //style={{ marginTop: 5,}}
                            />
                            <Texts size={12} color={colors.dimGray} style={{ marginLeft: 2 }}> {item.albumName}</Texts>
                        </View>
                    </View>
                </View>
                <Checkbox
